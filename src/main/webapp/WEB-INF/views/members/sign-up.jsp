                    ...
                    <form action="/members/sign-up" name="signup" id="signUpForm" method="post">
                        <ul>
                            ...
                            <li>
                                <div>비밀번호 확인</div>
                                <div>
                                <input type="re-password" size="17" maxlength="20" id="re-password" name="re-password"
                                    class="form-control" maxlength="20" required="required" aria-required="true"
                            ...
                            <li>
                                <div>성별</div>
                                <p>
                                    <label for="male">남성</label><input id="male" type="radio" value="남성" name="gd">
                                    <label for="female">여성</label><input id="female" type="radio" checked value="여성" name="gd">
                                </p>
                            </li>
                            <li>
                                <div>휴대전화</div>
