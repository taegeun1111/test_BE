...
<script>
    ...
    feedLists.forEach(feedList => {
        feedList.addEventListener('click', (e) => {
            ...
            if (e.target.closest(".like-it-count")) {
                console.log("테스트")
                ...
                if (!currentAccount) {
                    ...
                    window.location.href = 'http://localhost:8282/account/sign-in';
                } else {
                    if (clickLike) {
                        heartIcon.classList.toggle('like-ative');
                        console.log("clickLike true heart icon  = " + heartIcon);
                        clickLike = false;
                    } else {
                        if (e.target.closest(".like-it-count")) {
                            e.target.closest(".like-it-count").classList.toggle('like-ative');
                        console.log("clickLike false heart icon  = " + heartIcon);
                        }
                        clickLike = true;
                    }
