...
<body>
                ...
                <div class="user-info">
                    ...
                    <div class="user-detail-wrapper">
                        ...
                        <div class="write-time">
                            ...
                            <c:if test="${login.accountId==is.accountId}">
                                <div class="modify-warpper">
                                    <a href="/review/modify?bno=${is.secondHandBoardNo}">수정</a>
                                    <a href="/review/delete?bno=${is.secondHandBoardNo}">삭제</a>
                                </div>
                            </c:if>
                        </div>
                    </div>
    ...
    <script>
        ...
        function renderReplyList({
            ...
            if (scReplies === null || scReplies.length === 0) {
                tag += "<div id='replyContent' class='card-body'>현재 등록된 댓글이 없습니다</div>";
            } else {
                for (let rep of scReplies) {
