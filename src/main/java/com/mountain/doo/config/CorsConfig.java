...
public class CorsConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry){
        registry
                ...
                .allowedOrigins("http://localhost:3000", "https://ddamddamclub.shop","http://ddamddamclub.shop", "https://admin.ddamddamclub.shop","http://admin.ddamddamclub.shop") // 어떤 클라이언트를 허용할지
